...
public class MainActivity extends Activity implements View.OnClickListener
{
        ...
        radioGroupPlatform.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId)
            {
                if (radioButtonTP.getId() == checkedId)
                {
                    ...
                    etIP.setText("172.19.98.209");
                    etAccessCode.setText("8888");
                ...
                else if (radioButtonMS.getId() == checkedId)
                {
                    ...
                    etIP.setText("172.19.26.187");
                    etAccessCode.setText("60010");
    ...
    private int setHostAddress()
    {
        ...
        {
            etSIPAddress.setText("172.19.26.216");
            etSIPPort.setText("5060");
            etAudioAccesscode.setText("70010");
